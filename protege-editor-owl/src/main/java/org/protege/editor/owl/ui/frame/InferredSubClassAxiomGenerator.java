...
public class InferredSubClassAxiomGenerator extends
    ...
    private class SupFindVisitor implements OWLClassExpressionVisitor {
    	
    	private OWLClass cls = null;
    	private OWLOntology ont = null;
    	
    	private Set<OWLClass> sups = new HashSet<OWLClass>();
    	
    	public boolean contains(OWLClass s) { return sups.contains(s); }
