...
public class ReasonerPreferences {
    public enum OptionalInferenceTask {
        ...
        SHOW_INFERRED_SUPER_CLASSES(false, InferenceType.CLASS_HIERARCHY),
        SHOW_INFERED_CLASS_MEMBERS(false, InferenceType.CLASS_ASSERTIONS),
        SHOW_INFERRED_DISJOINT_CLASSES(false, InferenceType.CLASS_HIERARCHY),

        // Object Property Inferences
        SHOW_OBJECT_PROPERTY_UNSATISFIABILITY(false, InferenceType.OBJECT_PROPERTY_HIERARCHY),
        ...
        SHOW_INFERRED_EQUIVALENT_OBJECT_PROPERTIES(false, InferenceType.OBJECT_PROPERTY_HIERARCHY),
        SHOW_INFERRED_SUPER_OBJECT_PROPERTIES(false, InferenceType.OBJECT_PROPERTY_HIERARCHY),
        SHOW_INFERRED_INVERSE_PROPERTIES(false, InferenceType.OBJECT_PROPERTY_HIERARCHY),

        // Datatype Property Inferences
        SHOW_INFERRED_DATATYPE_PROPERTY_DOMAINS(false, InferenceType.CLASS_HIERARCHY),
        SHOW_INFERRED_EQUIVALENT_DATATYPE_PROPERTIES(false, InferenceType.DATA_PROPERTY_HIERARCHY),
        SHOW_INFERRED_SUPER_DATATYPE_PROPERTIES(false, InferenceType.DATA_PROPERTY_HIERARCHY),

        // Individual Inferences
        SHOW_INFERRED_TYPES(false, InferenceType.CLASS_ASSERTIONS),
        SHOW_INFERRED_OBJECT_PROPERTY_ASSERTIONS(false, InferenceType.OBJECT_PROPERTY_ASSERTIONS),
        SHOW_INFERRED_DATA_PROPERTY_ASSERTIONS(false, InferenceType.DATA_PROPERTY_ASSERTIONS),
        SHOW_INFERRED_SAMEAS_INDIVIDUAL_ASSERTIONS(false, InferenceType.SAME_INDIVIDUAL);
